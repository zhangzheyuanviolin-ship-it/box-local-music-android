...
/* 6 */     public class l0oOo0Ili1i extends AbstractExecutorService implements AutoCloseable, ExecutorService {
                public final ExecutorService I00iOIl;

                public l0oOo0Ili1i(ExecutorService executorService) {
...
/* 7 */             return new l10o01O(Executors.callable(runnable, obj));
                }
...
/* 12 */            return new l10o01O(callable);
                }
            }
