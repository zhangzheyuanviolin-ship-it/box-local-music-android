...
/* 78 */    public final class i11OIo extends i111I0010O implements RandomAccess, i11Oi0i0 {
                public static final i11OIo I00iio = new i11OIo(new int[0], 0, false);
                public int[] I00iiI;
                public int I00iiO;

                public i11OIo(int[] iArr, int i, boolean z) {
/* 1 */             super(z);
/* 4 */             this.I00iiI = iArr;
/* 6 */             this.I00iiO = i;
                }
...
/* 3 */             if (i >= this.I00iiO) {
/* 16 */                return new i11OIo(Arrays.copyOf(this.I00iiI, i), this.I00iiO, true);
                    }
...
/* 11 */            if (!(collection instanceof i11OIo)) {
/* 13 */                return super.addAll(collection);
                    }
/* 18 */            i11OIo i11oio = (i11OIo) collection;
/* 20 */            int i = i11oio.I00iiO;
/* 23 */            if (i == 0) {
/* 22 */                return false;
                    }
...
/* 52 */            System.arraycopy(i11oio.I00iiI, 0, iArrCopyOf, this.I00iiO, i11oio.I00iiO);
/* 55 */            this.I00iiO = i3;
                    ((AbstractList) this).modCount++;
/* 59 */            return true;
                }
...
/* 6 */             if (!(obj instanceof i11OIo)) {
/* 8 */                 return super.equals(obj);
                    }
/* 13 */            i11OIo i11oio = (i11OIo) obj;
/* 20 */            if (this.I00iiO == i11oio.I00iiO) {
/* 23 */                int[] iArr = i11oio.I00iiI;
