            ...
            public final class l0IlIi extends iolIIol1 implements RunnableFuture {
                public volatile ii1000i10O I00ioIO;

                public l0IlIi(Callable callable) {
...
/* 5 */             if ((obj instanceof ioO0lII0lI) && ((ioO0lII0lI) obj).I00000oIO && (ii1000i10o = this.I00ioIO) != null) {
/* 17 */                Iioo110oI iioo110oI = ii1000i10O.I00li1OI;
/* 19 */                Iioo110oI iioo110oI2 = ii1000i10O.I00l0OO0IO;
/* 25 */                Runnable runnable = (Runnable) ii1000i10o.get();
/* 29 */                if (runnable instanceof Thread) {
/* 33 */                    l00OiOii0Iil l00oioii0iil = new l00OiOii0Iil(ii1000i10o);
/* 1 */                     l00oioii0iil.setExclusiveOwnerThread(Thread.currentThread());
/* 47 */                    if (ii1000i10o.compareAndSet(runnable, l00oioii0iil)) {
                                try {
