...
/* 6 */     public class l01oII extends AbstractExecutorService implements AutoCloseable, ExecutorService {
                public final ExecutorService I00iOIl;

                public l01oII(ExecutorService executorService) {
...
/* 7 */             return new l0O1IIOoi(Executors.callable(runnable, obj));
                }
...
/* 12 */            return new l0O1IIOoi(callable);
                }
            }
