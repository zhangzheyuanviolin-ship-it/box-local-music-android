...
/* 4 */     public final class iiloIolOi0i implements OIOi0o {
...
/* 17 */            iiio100i00IO iiio100i00io = new iiio100i00IO();
/* 21 */            iiio100i00io.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(iiio100i00io);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            iiio100i00IO iiio100i00io2 = new iiio100i00IO();
/* 47 */            iiio100i00io2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(iiio100i00io2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(20);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             iilOol iilool = (iilOol) ilIO00o1.I00000oOI(iilOol.class);
/* 9 */             if (iilool != null) {
/* 11 */                return iilool.zza();
                    }
...
/* 326 */                       if (obj instanceof iilO00Il) {
/* 334 */                           I00000oOI(ilIO00o1, ((iilO00Il) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            iilOol iilool = (iilOol) ilIO00o1.I00000oOI(iilOol.class);
/* 13 */            if (iilool == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 215 */               return;
                    }
/* 19 */            int iOrdinal = iilool.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(iilool.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(iilool.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((iilool.zza() << 3) | 5);
...
/* 15 */            iilOol iilool = (iilOol) ilIO00o1.I00000oOI(iilOol.class);
/* 17 */            if (iilool == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 215 */               return;
                    }
/* 23 */            int iOrdinal = iilool.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(iilool.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(iilool.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((iilool.zza() << 3) | 1);
...
/* 4 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(5);
