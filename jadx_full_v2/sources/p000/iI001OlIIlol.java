            ...
            public abstract class iI001OlIIlol {
...
/* 1 */             i1oo0o0o i1oo0o0oVar = null;
                    try {
/* 12 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(6));
                    } catch (Throwable unused) {
/* 15 */                unsafe = null;
                    }
/* 16 */            I00000oIO = unsafe;
/* 18 */            int i = i1OO00ilI.I00000oIO;
...
/* 38 */            if (unsafe != null) {
/* 41 */                if (zI000OiO) {
/* 45 */                    i1oo0o0oVar = new i1oo0o0o(unsafe, c == true ? 1 : 0);
                        } else if (zI000OiO2) {
/* 53 */                    i1oo0o0oVar = new i1oo0o0o(unsafe, i2);
                        }
                    }
/* 56 */            I0000Il00O = i1oo0o0oVar;
/* 74 */            if (i1oo0o0oVar == null) {
/* 76 */                z = false;
                    } else {
                        try {
/* 80 */                    Class<?> cls3 = i1oo0o0oVar.I00000oOI.getClass();
...
/* 126 */                   Logger.getLogger(iI001OlIIlol.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 130 */           I0000O = z;
...
/* 244 */                   Logger.getLogger(iI001OlIIlol.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 248 */           I0000oI00 = z2;
