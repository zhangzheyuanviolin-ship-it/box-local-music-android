            ...
            public final class iI0lOolI extends Ooil0oIOI0l0 {
                public final int I0000Il00O;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public iI0lOolI(Unsafe unsafe, int i) {
/* 4 */             super(unsafe, 7);
/* 1 */             this.I0000Il00O = i;
                }
...
/* 12 */            return Float.intBitsToFloat(unsafe.getInt(obj, j));
                ...
                public final void I001iOo1i0O(Object obj, long j, boolean z) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 20 */                    if (!iI0lo1Oli.I0001Ioi1lo) {
/* 26 */                        iI0lo1Oli.I0000oI00(obj, j, z);
                                break;
                            } else {
/* 22 */                        iI0lo1Oli.I0000O(obj, j, z);
                                break;
                            }
                        default:
/* 8 */                     if (!iI0lo1Oli.I0001Ioi1lo) {
/* 14 */                        iI0lo1Oli.I0000oI00(obj, j, z);
                                break;
                            } else {
/* 10 */                        iI0lo1Oli.I0000O(obj, j, z);
                                break;
                            }
                    }
                }
...
/* 15 */            return iI0lo1Oli.I000OOo1O(j, obj);
                }
            }
