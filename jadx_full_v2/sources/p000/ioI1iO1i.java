...
/* 4 */     public final class ioI1iO1i implements OIOi0o {
...
/* 17 */            io0o0I0li1 io0o0i0li1 = new io0o0I0li1();
/* 21 */            io0o0i0li1.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(io0o0i0li1);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            io0o0I0li1 io0o0i0li12 = new io0o0I0li1();
/* 47 */            io0o0i0li12.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(io0o0i0li12);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(26);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             io1o0ol io1o0olVar = (io1o0ol) ilIO00o1.I00000oOI(io1o0ol.class);
/* 9 */             if (io1o0olVar != null) {
/* 11 */                return io1o0olVar.zza();
                    }
...
/* 326 */                       if (obj instanceof io1OOio1100) {
/* 334 */                           I00000oOI(ilIO00o1, ((io1OOio1100) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            io1o0ol io1o0olVar = (io1o0ol) ilIO00o1.I00000oOI(io1o0ol.class);
/* 13 */            if (io1o0olVar == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = io1o0olVar.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(io1o0olVar.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(io1o0olVar.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((io1o0olVar.zza() << 3) | 5);
...
/* 15 */            io1o0ol io1o0olVar = (io1o0ol) ilIO00o1.I00000oOI(io1o0ol.class);
/* 17 */            if (io1o0olVar == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = io1o0olVar.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(io1o0olVar.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(io1o0olVar.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((io1o0olVar.zza() << 3) | 1);
...
/* 5 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(9);
