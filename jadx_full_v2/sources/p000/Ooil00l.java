            ...
            public final class Ooil00l extends Ooil0oIOI0l0 {
                public final int I0000Il00O;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public Ooil00l(Unsafe unsafe, int i) {
/* 4 */             super(unsafe, 1);
/* 1 */             this.I0000Il00O = i;
                }
                ...
                public final boolean I00000oIO(long j, Object obj) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 39 */                    if (Ooil1O.I000II) {
/* 45 */                        if (Ooil1O.I0000oI00(j, obj) == 0) {
/* 37 */                            return false;
                                }
                            } else if (Ooil1O.I0001Ioi1lo(j, obj) == 0) {
/* 37 */                        return false;
                            }
/* 38 */                    return true;
                        case 1:
/* 17 */                    if (Ooil1O.I000II) {
/* 23 */                        if (Ooil1O.I0000oI00(j, obj) == 0) {
/* 15 */                            return false;
                                }
                            } else if (Ooil1O.I0001Ioi1lo(j, obj) == 0) {
/* 15 */                        return false;
...
/* 8 */                     return this.I00000oOI.getFloat(obj, j);
                ...
                public final void I0000oI00(Object obj, long j, boolean z) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 28 */                    if (!Ooil1O.I000II) {
/* 36 */                        Ooil1O.I000o00OoI0I(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            } else {
/* 31 */                        Ooil1O.I000lI(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            }
                        case 1:
/* 14 */                    if (!Ooil1O.I000II) {
/* 22 */                        Ooil1O.I000o00OoI0I(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            } else {
/* 17 */                        Ooil1O.I000lI(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            }
                        default:
/* 8 */                     this.I00000oOI.putBoolean(obj, j, z);
                ...
                public final void I0001Ioi1lo(Object obj, long j, byte b) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 26 */                    if (!Ooil1O.I000II) {
/* 32 */                        Ooil1O.I000o00OoI0I(obj, j, b);
                                break;
                            } else {
/* 28 */                        Ooil1O.I000lI(obj, j, b);
                                break;
                            }
                        case 1:
/* 14 */                    if (!Ooil1O.I000II) {
/* 20 */                        Ooil1O.I000o00OoI0I(obj, j, b);
                                break;
                            } else {
/* 16 */                        Ooil1O.I000lI(obj, j, b);
                                break;
                            }
                        default:
...
/* 127 */                                   Ooil1O.I000iOII(th);
/* 3 */                                     return false;
                                        }
                                    }
                                } catch (Throwable th2) {
/* 132 */                           Ooil1O.I000iOII(th2);
/* 3 */                             return false;
                                }
                            }
                            break;
