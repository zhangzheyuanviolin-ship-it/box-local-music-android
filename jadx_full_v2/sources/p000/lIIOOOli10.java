...
/* 78 */    public final class lIIOOOli10 extends l1Io0Iiio1o0 implements RandomAccess, lIO0lIi {
                public static final lIIOOOli10 I00iio = new lIIOOOli10(new int[0], 0, false);
                public int[] I00iiI;
                public int I00iiO;

                public lIIOOOli10(int[] iArr, int i, boolean z) {
/* 1 */             super(z);
/* 4 */             this.I00iiI = iArr;
/* 6 */             this.I00iiO = i;
                }
...
/* 11 */            if (!(collection instanceof lIIOOOli10)) {
/* 13 */                return super.addAll(collection);
                    }
/* 18 */            lIIOOOli10 liioooli10 = (lIIOOOli10) collection;
/* 20 */            int i = liioooli10.I00iiO;
/* 23 */            if (i == 0) {
/* 22 */                return false;
                    }
...
/* 52 */            System.arraycopy(liioooli10.I00iiI, 0, iArrCopyOf, this.I00iiO, liioooli10.I00iiO);
/* 55 */            this.I00iiO = i3;
                    ((AbstractList) this).modCount++;
/* 59 */            return true;
                }
...
/* 6 */             if (!(obj instanceof lIIOOOli10)) {
/* 8 */                 return super.equals(obj);
                    }
/* 13 */            lIIOOOli10 liioooli10 = (lIIOOOli10) obj;
/* 20 */            if (this.I00iiO == liioooli10.I00iiO) {
/* 23 */                int[] iArr = liioooli10.I00iiI;
...
/* 1 */             return this.I00iiO;
                ...
                @Override
                public final lIOIoo1O zzd(int i) {
/* 3 */             if (i >= this.I00iiO) {
/* 16 */                return new lIIOOOli10(Arrays.copyOf(this.I00iiI, i), this.I00iiO, true);
                    }
...
/* 81 */            I0000oI00(((Integer) obj).intValue());
                    return true;
                }
            }
