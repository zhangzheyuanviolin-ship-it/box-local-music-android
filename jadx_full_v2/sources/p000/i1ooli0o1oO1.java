            ...
            public abstract class i1ooli0o1oO1 {
...
/* 134 */               sb.append(": \"");
/* 139 */               i1ili1lI0 i1ili1li0 = i1ili1lI0.I00iiO;
/* 156 */               sb.append(lii10i1ooo.I00000oIO(new i1ili1lI0(((String) obj).getBytes(i1o1Iio.I00000oIO))));
/* 159 */               sb.append('\"');
/* 162 */               return;
                    }
/* 165 */           if (obj instanceof i1ili1lI0) {
/* 167 */               sb.append(": \"");
/* 176 */               sb.append(lii10i1ooo.I00000oIO((i1ili1lI0) obj));
/* 179 */               sb.append('\"');
/* 182 */               return;
                    }
/* 191 */           if (obj instanceof i1loi1lII) {
/* 195 */               sb.append(" {");
/* 200 */               I0000Il00O((i1loi1lII) obj, sb, i + 2);
/* 203 */               sb.append("\n");
/* 206 */               I00000oOI(i, sb);
/* 209 */               sb.append("}");
/* 212 */               return;
...
/* 15 */                i -= i2;
                ...
                */
                public static void I0000Il00O(i1loi1lII i1loi1lii, StringBuilder sb, int i) {
                    int i2;
                    int i3;
                    boolean zEquals;
                    Method method;
...
/* 26 */            Method[] declaredMethods = i1loi1lii.getClass().getDeclaredMethods();
...
/* 223 */                       I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-4, 0, strSubstring), i1loi1lII.I0000O(method2, i1loi1lii, new Object[0]));
                            }
/* 226 */                   i2 = i3;
                        }
...
/* 294 */                   I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-3, 0, strSubstring), i1loi1lII.I0000O(method, i1loi1lii, new Object[0]));
...
/* 352 */                   if (method4 != null) {
/* 356 */                       Object objI0000O = i1loi1lII.I0000O(method4, i1loi1lii, new Object[0]);
/* 360 */                       if (method5 == null) {
...
/* 438 */                                   zEquals = objI0000O.equals("");
                                        } else if (objI0000O instanceof i1ili1lI0) {
/* 449 */                                   zEquals = objI0000O.equals(i1ili1lI0.I00iiO);
                                        } else if (objI0000O instanceof i1i1lOIiiIIO) {
/* 472 */                                   if (objI0000O != ((i1loi1lII) ((i1loi1lII) ((i1i1lOIiiIIO) objI0000O)).I00000oIO(6))) {
                                            }
...
/* 453 */                               if (!zEquals) {
                                ...
                                } else if (((Boolean) i1loi1lII.I0000O(method5, i1loi1lii, new Object[0])).booleanValue()) {
                                }
                            }
                        }
/* 226 */               i2 = i3;
                    }
/* 510 */           iI0Ol11Il010 ii0ol11il010 = i1loi1lii.zzc;
/* 512 */           if (ii0ol11il010 != null) {
/* 516 */               for (int i5 = 0; i5 < ii0ol11il010.I00000oIO; i5++) {
/* 532 */                   I00000oIO(sb, i, String.valueOf(ii0ol11il010.I00000oOI[i5] >>> 3), ii0ol11il010.I0000Il00O[i5]);
                        }
                    }
                }
            }
