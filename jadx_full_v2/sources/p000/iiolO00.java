...
/* 4 */     public final class iiolO00 implements OIOi0o {
                ...
                public iIOo0oiIi1 I0000O;
                public OOiI1O I0000oI00;

                static {
/* 11 */            OlOO1i11110 olOO1i11110I00000oIO = IlIO00o1.I00000oIO("key");
/* 17 */            iio00OliII iio00oliii = new iio00OliII();
/* 21 */            iio00oliii.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(iio00oliii);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            iio00OliII iio00oliii2 = new iio00OliII();
/* 47 */            iio00oliii2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(iio00oliii2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(22);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             iioOIiOiOIol iiooiioioiol = (iioOIiOiOIol) ilIO00o1.I00000oOI(iioOIiOiOIol.class);
/* 9 */             if (iiooiioioiol != null) {
/* 11 */                return iiooiioioiol.zza();
                    }
...
/* 326 */                       if (obj instanceof iio1li1Io) {
/* 334 */                           I00000oOI(ilIO00o1, ((iio1li1Io) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            iioOIiOiOIol iiooiioioiol = (iioOIiOiOIol) ilIO00o1.I00000oOI(iioOIiOiOIol.class);
/* 13 */            if (iiooiioioiol == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = iiooiioioiol.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(iiooiioioiol.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(iiooiioioiol.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((iiooiioioiol.zza() << 3) | 5);
...
/* 15 */            iioOIiOiOIol iiooiioioiol = (iioOIiOiOIol) ilIO00o1.I00000oOI(iioOIiOiOIol.class);
/* 17 */            if (iiooiioioiol == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = iiooiioioiol.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(iiooiioioiol.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(iiooiioioiol.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((iiooiioioiol.zza() << 3) | 1);
...
/* 4 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(6);
...
/* 40 */                    I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 2);
/* 43 */                    I000II(j);
