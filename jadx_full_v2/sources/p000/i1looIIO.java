            ...
            public abstract class i1looIIO {
...
/* 134 */               sb.append(": \"");
/* 139 */               i1Ol0iIil i1ol0iiil = i1Ol0iIil.I00iiO;
/* 156 */               sb.append(liOlo010o0.I00000oIO(new i1Ol0iIil(((String) obj).getBytes(i1l0I01.I00000oIO))));
/* 159 */               sb.append('\"');
/* 162 */               return;
                    }
/* 165 */           if (obj instanceof i1Ol0iIil) {
/* 167 */               sb.append(": \"");
/* 176 */               sb.append(liOlo010o0.I00000oIO((i1Ol0iIil) obj));
/* 179 */               sb.append('\"');
/* 182 */               return;
                    }
/* 191 */           if (obj instanceof i1ilOol) {
/* 195 */               sb.append(" {");
/* 200 */               I0000Il00O((i1ilOol) obj, sb, i + 2);
/* 203 */               sb.append("\n");
/* 206 */               I00000oOI(i, sb);
/* 209 */               sb.append("}");
/* 212 */               return;
...
/* 15 */                i -= i2;
                ...
                */
                public static void I0000Il00O(i1ilOol i1ilool, StringBuilder sb, int i) {
                    int i2;
                    int i3;
                    boolean zEquals;
                    Method method;
...
/* 26 */            Method[] declaredMethods = i1ilool.getClass().getDeclaredMethods();
...
/* 223 */                       I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-4, 0, strSubstring), i1ilOol.I0000O(method2, i1ilool, new Object[0]));
                            }
/* 226 */                   i2 = i3;
                        }
...
/* 294 */                   I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-3, 0, strSubstring), i1ilOol.I0000O(method, i1ilool, new Object[0]));
...
/* 352 */                   if (method4 != null) {
/* 356 */                       Object objI0000O = i1ilOol.I0000O(method4, i1ilool, new Object[0]);
/* 360 */                       if (method5 == null) {
...
/* 438 */                                   zEquals = objI0000O.equals("");
                                        } else if (objI0000O instanceof i1Ol0iIil) {
/* 449 */                                   zEquals = objI0000O.equals(i1Ol0iIil.I00iiO);
                                        } else if (objI0000O instanceof i1O1lollIOO) {
/* 472 */                                   if (objI0000O != ((i1ilOol) ((i1ilOol) ((i1O1lollIOO) objI0000O)).I00000oIO(6))) {
                                            }
...
/* 453 */                               if (!zEquals) {
                                ...
                                } else if (((Boolean) i1ilOol.I0000O(method5, i1ilool, new Object[0])).booleanValue()) {
                                }
                            }
                        }
/* 226 */               i2 = i3;
                    }
/* 510 */           i1ol00i i1ol00iVar = i1ilool.zzc;
/* 512 */           if (i1ol00iVar != null) {
/* 516 */               for (int i5 = 0; i5 < i1ol00iVar.I00000oIO; i5++) {
/* 532 */                   I00000oIO(sb, i, String.valueOf(i1ol00iVar.I00000oOI[i5] >>> 3), i1ol00iVar.I0000Il00O[i5]);
                        }
                    }
                }
            }
