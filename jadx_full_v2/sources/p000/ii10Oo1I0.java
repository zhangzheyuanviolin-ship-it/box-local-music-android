            ...
            public abstract class ii10Oo1I0 {
...
/* 1 */             ii10OOi0loOO ii10ooi0looo = null;
                    try {
/* 13 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(11));
                    } catch (Throwable unused) {
/* 16 */                unsafe = null;
                    }
/* 17 */            I00000oIO = unsafe;
/* 19 */            int i = ii010oO01I.I00000oIO;
/* 23 */            I00000oOI = Memory.class;
/* 25 */            Class cls = Long.TYPE;
/* 27 */            boolean zI000o00OoI0I = I000o00OoI0I(cls);
/* 31 */            Class cls2 = Integer.TYPE;
/* 33 */            boolean zI000o00OoI0I2 = I000o00OoI0I(cls2);
/* 37 */            char c = 1;
/* 38 */            int i2 = 0;
/* 39 */            if (unsafe != null) {
/* 42 */                if (zI000o00OoI0I) {
/* 46 */                    ii10ooi0looo = new ii10OOi0loOO(unsafe, c == true ? 1 : 0);
                        } else if (zI000o00OoI0I2) {
/* 54 */                    ii10ooi0looo = new ii10OOi0loOO(unsafe, i2);
                        }
                    }
/* 57 */            I0000Il00O = ii10ooi0looo;
/* 75 */            if (ii10ooi0looo == null) {
/* 77 */                z = false;
                    } else {
                        try {
/* 81 */                    Class<?> cls3 = ii10ooi0looo.I00000oOI.getClass();
...
/* 127 */                   Logger.getLogger(ii10Oo1I0.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 131 */           I0000O = z;
...
/* 245 */                   Logger.getLogger(ii10Oo1I0.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 249 */           I0000oI00 = z2;
/* 258 */           I0001Ioi1lo = I000oI1ioi(byte[].class);
/* 262 */           I000oI1ioi(boolean[].class);
/* 265 */           I00000oIO(boolean[].class);
/* 270 */           I000oI1ioi(int[].class);
/* 273 */           I00000oIO(int[].class);
/* 278 */           I000oI1ioi(long[].class);
/* 281 */           I00000oIO(long[].class);
/* 286 */           I000oI1ioi(float[].class);
/* 289 */           I00000oIO(float[].class);
/* 294 */           I000oI1ioi(double[].class);
/* 297 */           I00000oIO(double[].class);
/* 302 */           I000oI1ioi(Object[].class);
...
/* 5 */             return I0000Il00O.I00000oOI.getObject(obj, j);
                ...
                public static void I000O01llI0(byte[] bArr, long j, byte b) {
/* 6 */             I0000Il00O.I001lIiIIo1O(bArr, I0001Ioi1lo + j, b);
                }

                public static void I000OOo1O(Object obj, long j, int i) {
/* 5 */             I0000Il00O.I00000oOI.putInt(obj, j, i);
                }

                public static void I000OiO(Object obj, long j, long j2) {
/* 8 */             I0000Il00O.I00000oOI.putLong(obj, j, j2);
                }

                public static void I000iOII(Object obj, long j, Object obj2) {
/* 5 */             I0000Il00O.I00000oOI.putObject(obj, j, obj2);
                ...
                public static boolean I000o00OoI0I(Class cls) {
/* 1 */             int i = ii010oO01I.I00000oIO;
                    try {
