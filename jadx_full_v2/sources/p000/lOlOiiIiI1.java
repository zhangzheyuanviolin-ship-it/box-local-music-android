            ...
            public abstract class lOlOiiIiI1 {
                public static String I00000oIO(IIO1ooI iIO1ooI) {
/* 7 */             StringBuilder sb = new StringBuilder(iIO1ooI.size());
/* 15 */            for (int i = 0; i < iIO1ooI.size(); i++) {
/* 17 */                byte bI00000oOI = iIO1ooI.I00000oOI(i);
/* 23 */                if (bI00000oOI == 34) {
/* 137 */                   sb.append("\\\"");
