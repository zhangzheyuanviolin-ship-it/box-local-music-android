...
/* 4 */     public final class Ooi1Ioi10 implements Collection, O0IlIoi {
                public short[] I00iOIl;
...
/* 4 */             if (!(obj instanceof Ooi1IIOloiii)) {
/* 3 */                 return false;
                    }
/* 9 */             short s = ((Ooi1IIOloiii) obj).I00iOIl;
/* 11 */            short[] sArr = this.I00iOIl;
/* 13 */            int length = sArr.length;
/* 14 */            int i = 0;
                    while (true) {
/* 15 */                if (i >= length) {
/* 25 */                    i = -1;
...
/* 1 */             short[] sArr = this.I00iOIl;
/* 3 */             Collection collection2 = collection;
/* 12 */            if (collection2.isEmpty()) {
/* 55 */                return true;
                    }
/* 23 */            for (Object obj : collection2) {
/* 32 */                if (obj instanceof Ooi1IIOloiii) {
/* 36 */                    short s = ((Ooi1IIOloiii) obj).I00iOIl;
/* 38 */                    int length = sArr.length;
/* 39 */                    int i = 0;
                            while (true) {
/* 40 */                        if (i >= length) {
/* 50 */                            i = -1;
...
/* 55 */            return true;
                ...
                public final boolean equals(Object obj) {
                    return (obj instanceof Ooi1Ioi10) && this.I00iOIl.equals(((Ooi1Ioi10) obj).I00iOIl);
                }
...
/* 1 */             short[] sArr = this.I00iOIl;
/* 6 */             I01I0Iioooo0 i01I0Iioooo0 = new I01I0Iioooo0(7);
/* 9 */             i01I0Iioooo0.I00iiO = sArr;
...
/* 22 */            return "UShortArray(storage=" + Arrays.toString(this.I00iOIl) + ')';
                }
