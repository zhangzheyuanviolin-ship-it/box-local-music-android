...
/* 6 */     public class ii00II01Iii0 extends AbstractExecutorService implements iOolO0lOooo, AutoCloseable {
                public final ExecutorService I00iOIl;

                public ii00II01Iii0(ExecutorService executorService) {
/* 4 */             executorService.getClass();
/* 7 */             this.I00iOIl = executorService;
                }

                public final ListenableFuture I00000oIO(Io11llo0i io11llo0i) {
/* 5 */             return (ListenableFuture) super.submit(io11llo0i);
                }
...
/* 7 */             return new ii110O0(Executors.callable(runnable, obj));
                }
...
/* 12 */            return new ii110O0(callable);
                }
            }
