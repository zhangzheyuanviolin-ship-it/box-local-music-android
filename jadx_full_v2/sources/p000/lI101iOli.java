...
/* 78 */    public final class lI101iOli extends l1Io0Iiio1o0 implements RandomAccess, lIIoI10O0O {
                public static final lI101iOli I00iio = new lI101iOli(new float[0], 0, false);
                public float[] I00iiI;
                public int I00iiO;

                public lI101iOli(float[] fArr, int i, boolean z) {
/* 1 */             super(z);
/* 4 */             this.I00iiI = fArr;
/* 6 */             this.I00iiO = i;
                }
...
/* 11 */            if (!(collection instanceof lI101iOli)) {
/* 13 */                return super.addAll(collection);
                    }
/* 18 */            lI101iOli li101ioli = (lI101iOli) collection;
/* 20 */            int i = li101ioli.I00iiO;
/* 23 */            if (i == 0) {
/* 22 */                return false;
                    }
...
/* 52 */            System.arraycopy(li101ioli.I00iiI, 0, fArrCopyOf, this.I00iiO, li101ioli.I00iiO);
/* 55 */            this.I00iiO = i3;
                    ((AbstractList) this).modCount++;
/* 59 */            return true;
                }
...
/* 6 */             if (!(obj instanceof lI101iOli)) {
/* 8 */                 return super.equals(obj);
                    }
/* 13 */            lI101iOli li101ioli = (lI101iOli) obj;
/* 20 */            if (this.I00iiO == li101ioli.I00iiO) {
/* 23 */                float[] fArr = li101ioli.I00iiI;
...
/* 3 */             if (i >= this.I00iiO) {
/* 16 */                return new lI101iOli(Arrays.copyOf(this.I00iiI, i), this.I00iiO, true);
                    }
