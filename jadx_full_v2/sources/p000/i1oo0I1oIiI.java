            ...
            public abstract class i1oo0I1oIiI {
...
/* 1 */             i1oill01lo i1oill01loVar = null;
                    try {
/* 12 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(4));
                    } catch (Throwable unused) {
/* 15 */                unsafe = null;
                    }
/* 16 */            I00000oIO = unsafe;
/* 18 */            int i = i1O1iOOOlo0O.I00000oIO;
...
/* 38 */            if (unsafe != null) {
/* 41 */                if (zI000OiO) {
/* 45 */                    i1oill01loVar = new i1oill01lo(unsafe, c == true ? 1 : 0);
                        } else if (zI000OiO2) {
/* 53 */                    i1oill01loVar = new i1oill01lo(unsafe, i2);
                        }
                    }
/* 56 */            I0000Il00O = i1oill01loVar;
/* 74 */            if (i1oill01loVar == null) {
/* 76 */                z = false;
                    } else {
                        try {
/* 80 */                    Class<?> cls3 = i1oill01loVar.I00000oOI.getClass();
...
/* 126 */                   Logger.getLogger(i1oo0I1oIiI.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 130 */           I0000O = z;
...
/* 244 */                   Logger.getLogger(i1oo0I1oIiI.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 248 */           I0000oI00 = z2;
...
/* 1 */             int i = i1O1iOOOlo0O.I00000oIO;
                    try {
