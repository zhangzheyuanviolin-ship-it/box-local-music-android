...
/* 4 */     public final class l1IIo10o11 implements OIOi0o {
...
/* 17 */            l11OIolOi l11oioloi = new l11OIolOi();
/* 21 */            l11oioloi.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(l11oioloi);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            l11OIolOi l11oioloi2 = new l11OIolOi();
/* 47 */            l11oioloi2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(l11oioloi2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 67 */            I000OOo1O = new l0iO10io0IOO(4);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             l1I101IO0lol l1i101io0lol = (l1I101IO0lol) ilIO00o1.I00000oOI(l1I101IO0lol.class);
/* 9 */             if (l1i101io0lol != null) {
/* 11 */                return l1i101io0lol.zza();
                    }
...
/* 326 */                       if (obj instanceof l11o00) {
/* 334 */                           I00000oOI(ilIO00o1, ((l11o00) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            l1I101IO0lol l1i101io0lol = (l1I101IO0lol) ilIO00o1.I00000oOI(l1I101IO0lol.class);
/* 13 */            if (l1i101io0lol == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = l1i101io0lol.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(l1i101io0lol.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(l1i101io0lol.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((l1i101io0lol.zza() << 3) | 5);
...
/* 15 */            l1I101IO0lol l1i101io0lol = (l1I101IO0lol) ilIO00o1.I00000oOI(l1I101IO0lol.class);
/* 17 */            if (l1i101io0lol == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = l1i101io0lol.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(l1i101io0lol.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(l1i101io0lol.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((l1i101io0lol.zza() << 3) | 1);
...
/* 5 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(13);
