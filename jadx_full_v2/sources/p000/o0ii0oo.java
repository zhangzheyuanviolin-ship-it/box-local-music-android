...
/* 1 */             o0iI1oilIlo o0ii1oililo = null;
                    try {
/* 13 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(22));
                    } catch (Throwable unused) {
/* 16 */                unsafe = null;
                    }
/* 17 */            I00000oIO = unsafe;
/* 19 */            int i = loi0l1O1OooI.I00000oIO;
/* 23 */            I00000oOI = Memory.class;
/* 25 */            Class cls = Long.TYPE;
/* 27 */            boolean zI000l1 = I000l1(cls);
/* 31 */            Class cls2 = Integer.TYPE;
/* 33 */            boolean zI000l12 = I000l1(cls2);
/* 37 */            char c = 1;
/* 38 */            int i2 = 0;
/* 39 */            if (unsafe != null) {
/* 42 */                if (zI000l1) {
/* 46 */                    o0ii1oililo = new o0iI1oilIlo(unsafe, c == true ? 1 : 0);
                        } else if (zI000l12) {
/* 54 */                    o0ii1oililo = new o0iI1oilIlo(unsafe, i2);
                        }
                    }
/* 57 */            I0000Il00O = o0ii1oililo;
/* 75 */            if (o0ii1oililo == null) {
/* 77 */                z = false;
                    } else {
                        try {
/* 81 */                    Class<?> cls3 = o0ii1oililo.I00000oOI.getClass();
...
/* 127 */                   Logger.getLogger(o0ii0oo.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 131 */           I0000O = z;
...
/* 245 */                   Logger.getLogger(o0ii0oo.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 249 */           I0000oI00 = z2;
/* 258 */           I0001Ioi1lo = I000lI(byte[].class);
/* 262 */           I000lI(boolean[].class);
/* 265 */           I00000oIO(boolean[].class);
/* 270 */           I000lI(int[].class);
/* 273 */           I00000oIO(int[].class);
/* 278 */           I000lI(long[].class);
/* 281 */           I00000oIO(long[].class);
/* 286 */           I000lI(float[].class);
/* 289 */           I00000oIO(float[].class);
/* 294 */           I000lI(double[].class);
/* 297 */           I00000oIO(double[].class);
/* 302 */           I000lI(Object[].class);
...
/* 1 */             int i = loi0l1O1OooI.I00000oIO;
                    try {
...
/* 5 */             I0000Il00O.I00000oOI.putObject(obj, j, obj2);
                ...
                public static boolean I000OiO(Object obj, long j) {
