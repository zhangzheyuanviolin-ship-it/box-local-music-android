            ...
            public abstract class o0li1IlO0 {
                public static final int[] I00000oIO = {0, 0, 1, 2, 4, 8, 16};
                public static final SecureRandom I00000oOI = new SecureRandom();

                public static boolean I00000oIO(o0lOOi0l1II o0looi0l1ii) throws InterruptedException {
/* 6 */             for (int i = 0; i < 7; i++) {
...
/* 28 */                    Thread.sleep(I00000oOI.nextInt(i3) + (i3 / 2));
                        ...
                        try {
                        } catch (IOException | o0iolOlII11I e) {
