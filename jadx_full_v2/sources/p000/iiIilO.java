...
/* 4 */     public final class iiIilO implements OIOi0o {
...
/* 17 */            ii100liOOI0 ii100liooi0 = new ii100liOOI0();
/* 21 */            ii100liooi0.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(ii100liooi0);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            ii100liOOI0 ii100liooi02 = new ii100liOOI0();
/* 47 */            ii100liooi02.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(ii100liooi02);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(16);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             iiI1iio iii1iio = (iiI1iio) ilIO00o1.I00000oOI(iiI1iio.class);
/* 9 */             if (iii1iio != null) {
/* 11 */                return iii1iio.zza();
                    }
...
/* 326 */                       if (obj instanceof ii1il1I0iI) {
/* 334 */                           I00000oOI(ilIO00o1, ((ii1il1I0iI) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            iiI1iio iii1iio = (iiI1iio) ilIO00o1.I00000oOI(iiI1iio.class);
/* 13 */            if (iii1iio == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = iii1iio.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(iii1iio.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(iii1iio.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((iii1iio.zza() << 3) | 5);
...
/* 15 */            iiI1iio iii1iio = (iiI1iio) ilIO00o1.I00000oOI(iiI1iio.class);
/* 17 */            if (iii1iio == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = iii1iio.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(iii1iio.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(iii1iio.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((iii1iio.zza() << 3) | 1);
...
/* 4 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(2);
