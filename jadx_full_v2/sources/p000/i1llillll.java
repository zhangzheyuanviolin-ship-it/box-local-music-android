            ...
            public abstract class i1llillll {
...
/* 134 */               sb.append(": \"");
/* 139 */               i1OOll0 i1ooll0 = i1OOll0.I00iiO;
/* 156 */               sb.append(liOliil.I00000oIO(new i1OOll0(((String) obj).getBytes(i1io0iill0.I00000oIO))));
/* 159 */               sb.append('\"');
/* 162 */               return;
                    }
/* 165 */           if (obj instanceof i1OOll0) {
/* 167 */               sb.append(": \"");
/* 176 */               sb.append(liOliil.I00000oIO((i1OOll0) obj));
/* 179 */               sb.append('\"');
/* 182 */               return;
                    }
/* 191 */           if (obj instanceof i1ii0i) {
/* 195 */               sb.append(" {");
/* 200 */               I0000Il00O((i1ii0i) obj, sb, i + 2);
/* 203 */               sb.append("\n");
/* 206 */               I00000oOI(i, sb);
/* 209 */               sb.append("}");
/* 212 */               return;
...
/* 15 */                i -= i2;
                ...
                */
                public static void I0000Il00O(i1ii0i i1ii0iVar, StringBuilder sb, int i) {
                    int i2;
                    int i3;
                    boolean zEquals;
                    Method method;
...
/* 26 */            Method[] declaredMethods = i1ii0iVar.getClass().getDeclaredMethods();
...
/* 223 */                       I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-4, 0, strSubstring), i1ii0i.I0000O(method2, i1ii0iVar, new Object[0]));
                            }
/* 226 */                   i2 = i3;
                        }
...
/* 294 */                   I00000oIO(sb, i, OooioIOo1.I00100o1O0lo(-3, 0, strSubstring), i1ii0i.I0000O(method, i1ii0iVar, new Object[0]));
...
/* 352 */                   if (method4 != null) {
/* 356 */                       Object objI0000O = i1ii0i.I0000O(method4, i1ii0iVar, new Object[0]);
/* 360 */                       if (method5 == null) {
...
/* 438 */                                   zEquals = objI0000O.equals("");
                                        } else if (objI0000O instanceof i1OOll0) {
/* 449 */                                   zEquals = objI0000O.equals(i1OOll0.I00iiO);
                                        } else if (objI0000O instanceof i1O101Oo0) {
/* 472 */                                   if (objI0000O != ((i1ii0i) ((i1ii0i) ((i1O101Oo0) objI0000O)).I00000oIO(6))) {
                                            }
...
/* 453 */                               if (!zEquals) {
                                ...
                                } else if (((Boolean) i1ii0i.I0000O(method5, i1ii0iVar, new Object[0])).booleanValue()) {
                                }
                            }
                        }
/* 226 */               i2 = i3;
                    }
/* 510 */           i1oiI1 i1oii1 = i1ii0iVar.zzc;
/* 512 */           if (i1oii1 != null) {
/* 516 */               for (int i5 = 0; i5 < i1oii1.I00000oIO; i5++) {
/* 532 */                   I00000oIO(sb, i, String.valueOf(i1oii1.I00000oOI[i5] >>> 3), i1oii1.I0000Il00O[i5]);
                        }
                    }
                }
            }
