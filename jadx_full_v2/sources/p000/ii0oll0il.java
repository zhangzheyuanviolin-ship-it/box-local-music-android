            ...
            public final class ii0oll0il extends AbstractMap {
...
/* 8 */             if (iI0000O >= 0) {
/* 16 */                return ((ii0ooilOOoO) this.I00iOIl[iI0000O]).setValue(obj);
                    }
/* 21 */            I000OOo1O();
...
/* 56 */                ii0ooilOOoO ii0ooiloooo = (ii0ooilOOoO) objArr[15];
/* 58 */                this.I00iiI = 15;
/* 68 */                I000O01llI0().put(ii0ooiloooo.I00iOIl, ii0ooiloooo.I00iiI);
                    }
/* 71 */            Object[] objArr2 = this.I00iOIl;
/* 75 */            int length = objArr2.length;
/* 78 */            System.arraycopy(objArr2, i, objArr2, i + 1, 15 - i);
/* 88 */            this.I00iOIl[i] = new ii0ooilOOoO(this, comparable, obj);
                    this.I00iiI++;
/* 96 */            return null;
                }

                public final ii0ooilOOoO I0000Il00O(int i) {
/* 3 */             if (i < this.I00iiI) {
/* 9 */                 return (ii0ooilOOoO) this.I00iOIl[i];
                    }
...
/* 5 */             int i3 = 0;
/* 6 */             if (i2 >= 0) {
/* 16 */                int iCompareTo = comparable.compareTo(((ii0ooilOOoO) this.I00iOIl[i2]).I00iOIl);
/* 20 */                if (iCompareTo > 0) {
/* 24 */                    return -(i + 1);
                        }
/* 26 */                if (iCompareTo == 0) {
...
/* 30 */            while (i3 <= i2) {
/* 34 */                int i4 = (i3 + i2) / 2;
/* 44 */                int iCompareTo2 = comparable.compareTo(((ii0ooilOOoO) this.I00iOIl[i4]).I00iOIl);
/* 48 */                if (iCompareTo2 < 0) {
                            i2 = i4 - 1;
                        } else {
/* 53 */                    if (iCompareTo2 <= 0) {
...
/* 10 */            Object obj = ((ii0ooilOOoO) objArr[i]).I00iiI;
...
/* 73 */                objArr2[i2] = new ii0ooilOOoO(this, (Comparable) entry.getKey(), entry.getValue());
                        this.I00iiI++;
/* 81 */                it.remove();
                    }
/* 168 */           return obj;
...
/* 11 */                this.I00ilI0I1 = new I1IlioI1o1I(this, 6);
                    }
...
/* 6 */             if (!(obj instanceof ii0oll0il)) {
/* 8 */                 return super.equals(obj);
                    }
/* 13 */            ii0oll0il ii0oll0ilVar = (ii0oll0il) obj;
/* 15 */            int size = size();
/* 24 */            if (size == ii0oll0ilVar.size()) {
/* 26 */                int i = this.I00iiI;
/* 30 */                if (i != ii0oll0ilVar.I00iiI) {
/* 74 */                    return entrySet().equals(ii0oll0ilVar.entrySet());
                        }
/* 33 */                for (int i2 = 0; i2 < i; i2++) {
/* 47 */                    if (I0000Il00O(i2).equals(ii0oll0ilVar.I0000Il00O(i2))) {
                            }
                        }
/* 53 */                if (i != size) {
/* 59 */                    return this.I00iiO.equals(ii0oll0ilVar.I00iiO);
                        }
/* 64 */                return true;
                    }
/* 23 */            return false;
...
/* 3 */             int iI0000O = I0000O(comparable);
                    return iI0000O >= 0 ? ((ii0ooilOOoO) this.I00iOIl[iI0000O]).I00iiI : this.I00iiO.get(comparable);
                }
