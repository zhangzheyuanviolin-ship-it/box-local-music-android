...
/* 28 */            if (cls == null || zziVar == null) {
/* 59 */                if (strI0000O != null) {
/* 61 */                    return strI000lI.concat(strI0000O);
                        }
/* 66 */                return null;
                    }
/* 45 */            StringBuilder sbI00111O = IIl001iO0Io.I00111O(strI000lI, "exceptionType=[", cls.toString(), "], fallback=[", zziVar.toString());
/* 51 */            sbI00111O.append("]");
...
/* 3 */             Class cls = this.I00l0I0l0lO1;
/* 5 */             zzi zziVar = this.I00l0OO0IO;
/* 24 */            if (((zziVar == null) || ((listenableFuture == null) | (cls == null))) || (this.I00iOIl instanceof ioO0o00)) {
/* 245 */               return;
                    }
/* 35 */            this.I00ioIO = null;
                    try {
/* 53 */                th = listenableFuture instanceof ioOi0ll1 ? ((ioOi0ll1) listenableFuture).I00000oOI() : null;
...
/* 61 */            Object objI0000oI00 = th == null ? lioli1IO.I0000oI00(listenableFuture) : null;
/* 102 */           if (th == null) {
...
/* 245 */               return;
                    ...
                    try {
/* 114 */               ListenableFuture listenableFutureZza = zziVar.zza(th);
/* 118 */               if (listenableFutureZza == null) {
/* 143 */                   throw new NullPointerException(lio1IIoIi.I00000oIO("AsyncFunction.apply returned null instead of a Future. Did you mean to return immediateFuture(null)? %s", zziVar));
                        }
