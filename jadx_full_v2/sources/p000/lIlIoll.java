...
/* 78 */    public final class lIlIoll extends l1Io0Iiio1o0 implements RandomAccess, lIO1oOo01 {
                public static final lIlIoll I00iio = new lIlIoll(new long[0], 0, false);
                public long[] I00iiI;
                public int I00iiO;

                public lIlIoll(long[] jArr, int i, boolean z) {
/* 1 */             super(z);
/* 4 */             this.I00iiI = jArr;
/* 6 */             this.I00iiO = i;
                }
...
/* 11 */            if (!(collection instanceof lIlIoll)) {
/* 13 */                return super.addAll(collection);
                    }
/* 18 */            lIlIoll lilioll = (lIlIoll) collection;
/* 20 */            int i = lilioll.I00iiO;
/* 23 */            if (i == 0) {
/* 22 */                return false;
                    }
...
/* 52 */            System.arraycopy(lilioll.I00iiI, 0, jArrCopyOf, this.I00iiO, lilioll.I00iiO);
/* 55 */            this.I00iiO = i3;
                    ((AbstractList) this).modCount++;
/* 59 */            return true;
                }
...
/* 6 */             if (!(obj instanceof lIlIoll)) {
/* 8 */                 return super.equals(obj);
                    }
/* 13 */            lIlIoll lilioll = (lIlIoll) obj;
/* 20 */            if (this.I00iiO == lilioll.I00iiO) {
/* 23 */                long[] jArr = lilioll.I00iiI;
...
/* 13 */                Charset charset = lIOOlo11OOii.I00000oIO;
...
/* 3 */             if (i >= this.I00iiO) {
/* 16 */                return new lIlIoll(Arrays.copyOf(this.I00iiI, i), this.I00iiO, true);
                    }
