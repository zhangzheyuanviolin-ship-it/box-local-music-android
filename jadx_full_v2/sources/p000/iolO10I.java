            ...
            public abstract class iolO10I {
                ...
                */
                public static final iil0il1000i0 I00000oIO() throws Exception {
...
/* 9 */             if (egl10 == null) {
/* 388 */               throw new il11lI(0, "EGLContext.getEGL() returned null");
                    }
...
/* 380 */                   throw il11lI.I00000oIO(egl10, "egl.eglGetDisplay(EGL10.EGL_DEFAULT_DISPLAY)");
                        }
...
/* 136 */                   if (iArr[0] <= 0) {
/* 215 */                       throw new il11lI(0, "No matching configs found for set " + i);
                            }
...
/* 373 */               throw il11lI.I00000oIO(egl10, "Finding or creating a context");
                    }
...
/* 366 */               throw new il11lI(0, "Got null value for a GL string");
                    }
/* 293 */           Matcher matcher = I00000oIO.matcher(strGlGetString);
/* 301 */           if (!matcher.find() || matcher.groupCount() != 3) {
/* 358 */               throw new il11lI(0, "Failed to parse version from ".concat(strGlGetString));
                    }
/* 316 */           int i5 = Integer.parseInt(matcher.group(2), 10);
/* 324 */           int i6 = Integer.parseInt(matcher.group(3), 10);
/* 330 */           iil0il1000i0 iil0il1000i0Var = new iil0il1000i0();
/* 333 */           iil0il1000i0Var.I00000oIO = strGlGetString2;
/* 335 */           iil0il1000i0Var.I00000oOI = strGlGetString;
/* 337 */           iil0il1000i0Var.I0000Il00O = i5;
/* 339 */           iil0il1000i0Var.I0000O = i6;
/* 341 */           iil0il1000i0Var.I0000oI00 = strGlGetString3;
/* 343 */           VarHandle.storeStoreFence();
/* 346 */           return iil0il1000i0Var;
                }

                public static void I00000oOI(EGL10 egl10, String str) throws il11lI {
/* 1 */             int iEglGetError = egl10.eglGetError();
/* 7 */             if (iEglGetError != 12288) {
/* 37 */                throw new il11lI(iEglGetError, IlIi0I0.I000OiO(iEglGetError, "EGL error ", " during ", str));
                    }
                }

                public static void I0000Il00O(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr, EGLConfig[] eGLConfigArr, int i, int[] iArr2) throws il11lI {
                    try {
/* 1 */                 egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, i, iArr2);
/* 6 */                 I00000oOI(egl10, "egl.eglChooseConfig");
                    } catch (RuntimeException e) {
/* 24 */                il11lI il11li = new il11lI("egl.eglChooseConfig failed with ".concat(e.toString()), e);
/* 28 */                il11li.I00iOIl = 0;
