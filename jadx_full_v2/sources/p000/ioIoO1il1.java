...
/* 28 */            if (cls == null || zzhVar == null) {
/* 59 */                if (strI0000O != null) {
/* 61 */                    return strI000lI.concat(strI0000O);
                        }
/* 66 */                return null;
                    }
/* 45 */            StringBuilder sbI00111O = IIl001iO0Io.I00111O(strI000lI, "exceptionType=[", cls.toString(), "], fallback=[", zzhVar.toString());
/* 51 */            sbI00111O.append("]");
...
/* 1 */             ListenableFuture listenableFuture = this.I00ioIO;
/* 3 */             boolean z = false;
/* 15 */            if ((listenableFuture != null) & (this.I00iOIl instanceof ioO0lII0lI)) {
/* 17 */                Object obj = this.I00iOIl;
/* 21 */                if ((obj instanceof ioO0lII0lI) && ((ioO0lII0lI) obj).I00000oIO) {
/* 29 */                    z = true;
                        }
...
/* 3 */             Class cls = this.I00l0I0l0lO1;
/* 5 */             zzh zzhVar = this.I00l0OO0IO;
/* 24 */            if (((zzhVar == null) || ((listenableFuture == null) | (cls == null))) || (this.I00iOIl instanceof ioO0lII0lI)) {
/* 245 */               return;
                    }
/* 35 */            this.I00ioIO = null;
                    try {
/* 53 */                th = listenableFuture instanceof ioOi11iiI ? ((ioOi11iiI) listenableFuture).I00000oOI() : null;
...
/* 61 */            Object objI0000oI00 = th == null ? liolilo.I0000oI00(listenableFuture) : null;
/* 102 */           if (th == null) {
...
/* 245 */               return;
                    ...
                    try {
/* 114 */               ListenableFuture listenableFutureZza = zzhVar.zza(th);
/* 118 */               if (listenableFutureZza == null) {
/* 143 */                   throw new NullPointerException(lio1IOlIiiO.I00000oIO("AsyncFunction.apply returned null instead of a Future. Did you mean to return immediateFuture(null)? %s", zzhVar));
                        }
