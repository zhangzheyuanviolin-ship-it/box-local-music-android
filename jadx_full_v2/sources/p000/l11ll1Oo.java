            ...
            public class l11ll1Oo implements Closeable {
                ...
                public l11ll1Oo(String str) {
                }

                public static l11ll1Oo I000O01llI0(String str) {
/* 1 */             l1I0oI.I0010o();
/* 4 */             l1I0oI.I0010o();
/* 13 */            if (!Boolean.parseBoolean("")) {
/* 15 */                return l11OOIll.I00io1l;
                    }
/* 18 */            HashMap map = I00ilO0;
/* 24 */            if (map.get(str) == null) {
/* 31 */                map.put(str, new l11ll1Oo(str));
                    }
/* 38 */            return (l11ll1Oo) map.get(str);
                }
...
/* 9 */             I0000Il00O((SystemClock.elapsedRealtimeNanos() / 1000) - j);
                ...
                @Override
                public void close() {
/* 14 */            lil0lI0lI1.I00000oIO("Did you forget to call start()?", this.I00iiI != 0);
/* 19 */            I000II(this.I00iiI);
                }
            }
