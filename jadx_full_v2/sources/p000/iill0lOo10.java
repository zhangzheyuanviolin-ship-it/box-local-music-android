...
/* 4 */     public final class iill0lOo10 implements OIOi0o {
...
/* 17 */            iiiiIilO1iIo iiiiiilo1iio = new iiiiIilO1iIo();
/* 21 */            iiiiiilo1iio.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(iiiiiilo1iio);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            iiiiIilO1iIo iiiiiilo1iio2 = new iiiiIilO1iIo();
/* 47 */            iiiiiilo1iio2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(iiiiiilo1iio2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 63 */            I000OOo1O = iIOo0oiIi1.I0001Ioi1lo;
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             iilO1lOO iilo1loo = (iilO1lOO) ilIO00o1.I00000oOI(iilO1lOO.class);
/* 9 */             if (iilo1loo != null) {
/* 11 */                return iilo1loo.zza();
                    }
...
/* 327 */                       if (obj instanceof iilII01IIilo) {
/* 335 */                           I00000oOI(ilIO00o1, ((iilII01IIilo) obj).zza(), true);
/* 338 */                           return this;
                                }
...
/* 11 */            iilO1lOO iilo1loo = (iilO1lOO) ilIO00o1.I00000oOI(iilO1lOO.class);
/* 13 */            if (iilo1loo == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = iilo1loo.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(iilo1loo.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(iilo1loo.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((iilo1loo.zza() << 3) | 5);
...
/* 15 */            iilO1lOO iilo1loo = (iilO1lOO) ilIO00o1.I00000oOI(iilO1lOO.class);
/* 17 */            if (iilo1loo == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = iilo1loo.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(iilo1loo.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(iilo1loo.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((iilo1loo.zza() << 3) | 1);
...
/* 6 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(4);
