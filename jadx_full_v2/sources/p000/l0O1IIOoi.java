            ...
            public final class l0O1IIOoi extends ioo0IOiOoi1 implements RunnableFuture {
                public volatile ii1000i10O I00ioIO;

                public l0O1IIOoi(Callable callable) {
...
/* 5 */             if ((obj instanceof ioOlI0i1) && ((ioOlI0i1) obj).I00000oIO && (ii1000i10o = this.I00ioIO) != null) {
/* 17 */                Iioo110oI iioo110oI = ii1000i10O.I00lli11;
/* 19 */                Iioo110oI iioo110oI2 = ii1000i10O.I00ll1;
/* 25 */                Runnable runnable = (Runnable) ii1000i10o.get();
/* 29 */                if (runnable instanceof Thread) {
/* 33 */                    l00loil l00loilVar = new l00loil(ii1000i10o);
/* 1 */                     l00loilVar.setExclusiveOwnerThread(Thread.currentThread());
/* 47 */                    if (ii1000i10o.compareAndSet(runnable, l00loilVar)) {
                                try {
