            ...
            public final class IOOO0lio extends IOOOI0 {
                public FileInputStream I0000Il00O;
                public byte[] I0000O;
...
/* 3 */             I00ll1();
                ...
                @Override
                public final int I000lI(int i) throws O0011oo {
/* 1 */             if (i < 0) {
/* 77 */                throw O0011oo.I0000O();
                    }
/* 8 */             int i2 = this.I000OOo1O + this.I000II + i;
/* 9 */             if (i2 < 0) {
/* 33 */                throw new O0011oo("Failed to parse the message.");
                    }
/* 11 */            int i3 = this.I000OiO;
/* 13 */            if (i2 > i3) {
/* 25 */                throw O0011oo.I0000oI00();
                    }
/* 15 */            this.I000OiO = i2;
/* 17 */            I00ll1();
/* 20 */            return i3;
                ...
                @Override
                public final IIO1ooI I00100l0() throws IOException {
...
/* 16 */                IIO1ooI iIO1ooII0000oI00 = IIO1ooI.I0000oI00(bArr, i2, iI00l0I0l0lO1);
...
/* 31 */            if (iI00l0I0l0lO1 < 0) {
/* 110 */               throw O0011oo.I0000O();
                    }
/* 33 */            byte[] bArrI00ilI0I1 = I00ilI0I1(iI00l0I0l0lO1);
/* 38 */            if (bArrI00ilI0I1 != null) {
/* 41 */                return IIO1ooI.I0000oI00(bArrI00ilI0I1, 0, bArrI00ilI0I1.length);
                    }
/* 46 */            int i3 = this.I000II;
/* 48 */            int i4 = this.I0000oI00;
/* 50 */            int length = i4 - i3;
                    this.I000OOo1O += i4;
/* 57 */            this.I000II = 0;
/* 59 */            this.I0000oI00 = 0;
/* 63 */            ArrayList arrayListI00ilO0 = I00ilO0(iI00l0I0l0lO1 - length);
/* 67 */            byte[] bArr2 = new byte[iI00l0I0l0lO1];
/* 69 */            System.arraycopy(bArr, i3, bArr2, 0, length);
/* 72 */            Iterator it = arrayListI00ilO0.iterator();
/* 80 */            while (it.hasNext()) {
/* 86 */                byte[] bArr3 = (byte[]) it.next();
/* 89 */                System.arraycopy(bArr3, 0, bArr2, length, bArr3.length);
/* 93 */                length += bArr3.length;
                    }
/* 95 */            IIO1ooI iIO1ooI = IIO1ooI.I00iiO;
/* 99 */            return new IIO1ooI(bArr2);
                }
...
/* 1 */             int iI00l0I0l0lO1 = I00l0I0l0lO1();
/* 10 */            return (-(iI00l0I0l0lO1 & 1)) ^ (iI00l0I0l0lO1 >>> 1);
                }

                @Override
                public final long I001lIiIIo1O() {
/* 1 */             long jI00l0OO0IO = I00l0OO0IO();
/* 12 */            return (-(jI00l0OO0IO & 1)) ^ (jI00l0OO0IO >>> 1);
                }
...
/* 20 */                    String str = new String(bArr, i2, iI00l0I0l0lO1, IoolIIolo1lI.I00000oIO);
                            this.I000II += iI00l0I0l0lO1;
/* 28 */                    return str;
                        }
                    }
...
/* 34 */            if (iI00l0I0l0lO1 < 0) {
/* 110 */               throw O0011oo.I0000O();
                    }
/* 38 */            if (iI00l0I0l0lO1 > this.I0000oI00) {
/* 66 */                return new String(I00iio(iI00l0I0l0lO1), IoolIIolo1lI.I00000oIO);
                    }
/* 40 */            I00lli11(iI00l0I0l0lO1);
/* 49 */            String str2 = new String(bArr, this.I000II, iI00l0I0l0lO1, IoolIIolo1lI.I00000oIO);
                    this.I000II += iI00l0I0l0lO1;
/* 57 */            return str2;
                }
...
/* 27 */                if (iI00l0I0l0lO1 < 0) {
/* 55 */                    throw O0011oo.I0000O();
                        }
/* 29 */                i = 0;
/* 30 */                if (iI00l0I0l0lO1 <= i2) {
/* 32 */                    I00lli11(iI00l0I0l0lO1);
/* 35 */                    this.I000II = iI00l0I0l0lO1;
                        } else {
/* 38 */                    bArrI00iio = I00iio(iI00l0I0l0lO1);
                        }
                    }
/* 44 */            return Ooll0IoO.I00000oIO.I00000oIO(bArrI00iio, i, iI00l0I0l0lO1);
                }
...
/* 64 */            if (this.I0000oI00 - this.I000II >= 10) {
/* 66 */                while (i3 < 10) {
/* 68 */                    int i4 = this.I000II;
/* 72 */                    this.I000II = i4 + 1;
/* 76 */                    if (bArr[i4] < 0) {
/* 79 */                        i3++;
                            }
...
/* 87 */            while (i3 < 10) {
/* 93 */                if (this.I000II == this.I0000oI00) {
/* 95 */                    I00lli11(1);
                        }
/* 98 */                int i5 = this.I000II;
/* 102 */               this.I000II = i5 + 1;
/* 106 */               if (bArr[i5] < 0) {
/* 109 */                   i3++;
                        }
                    }
...
/* 1 */             FileInputStream fileInputStream = this.I0000Il00O;
/* 3 */             if (i == 0) {
/* 5 */                 return IoolIIolo1lI.I00000oOI;
                    }
/* 8 */             if (i < 0) {
/* 168 */               throw O0011oo.I0000O();
                    }
/* 10 */            int i2 = this.I000OOo1O;
/* 12 */            int i3 = this.I000II;
/* 16 */            int i4 = i2 + i3 + i;
/* 22 */            if (i4 - Integer.MAX_VALUE > 0) {
/* 117 */               throw new O0011oo("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
                    }
/* 24 */            int i5 = this.I000OiO;
/* 26 */            if (i4 > i5) {
/* 102 */               I00lll10((i5 - i2) - i3);
/* 109 */               throw O0011oo.I0000oI00();
                    }
...
/* 77 */            return arrayList;
                ...
                public final int I00io1l() throws O0011oo {
/* 1 */             int i = this.I000II;
...
/* 187 */           return I00li1OI();
                ...
                public final long I00li1OI() throws O0011oo {
/* 1 */             long j = 0;
...
/* 19 */            this.I0000oI00 = i - i4;
                ...
                public final void I00lli11(int i) throws O0011oo {
/* 5 */             if (I00o0iI0io1(i)) {
/* 77 */                return;
                    }
/* 16 */            if (i <= (Integer.MAX_VALUE - this.I000OOo1O) - this.I000II) {
/* 30 */                throw O0011oo.I0000oI00();
                    }
/* 25 */            throw new O0011oo("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
                }

                public final void I00lll10(int i) throws O0011oo {
...
/* 14 */            FileInputStream fileInputStream = this.I0000Il00O;
/* 16 */            if (i < 0) {
/* 168 */               throw O0011oo.I0000O();
                    }
...
/* 99 */                        I000II.I000II(i6, fileInputStream.getClass());
/* 11 */                        return false;
                            }
/* 74 */                    if (i6 > 0) {
                                this.I0000oI00 += i6;
