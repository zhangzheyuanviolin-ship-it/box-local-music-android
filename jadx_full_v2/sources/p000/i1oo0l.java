...
/* 1 */             i1oiolooIlo i1oiolooilo = null;
                    try {
/* 12 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(5));
                    } catch (Throwable unused) {
/* 15 */                unsafe = null;
                    }
/* 16 */            I00000oIO = unsafe;
/* 18 */            int i = i1O1iio0o.I00000oIO;
...
/* 38 */            if (unsafe != null) {
/* 41 */                if (zI000OiO) {
/* 45 */                    i1oiolooilo = new i1oiolooIlo(unsafe, c == true ? 1 : 0);
                        } else if (zI000OiO2) {
/* 53 */                    i1oiolooilo = new i1oiolooIlo(unsafe, i2);
                        }
                    }
/* 56 */            I0000Il00O = i1oiolooilo;
/* 74 */            if (i1oiolooilo == null) {
/* 76 */                z = false;
                    } else {
                        try {
/* 80 */                    Class<?> cls3 = i1oiolooilo.I00000oOI.getClass();
...
/* 126 */                   Logger.getLogger(i1oo0l.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 130 */           I0000O = z;
...
/* 244 */                   Logger.getLogger(i1oo0l.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 248 */           I0000oI00 = z2;
