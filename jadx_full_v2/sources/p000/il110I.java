...
/* 4 */     public final class il110I implements OIOi0o {
...
/* 17 */            il0I01IoO0I il0i01ioo0i = new il0I01IoO0I();
/* 21 */            il0i01ioo0i.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(il0i01ioo0i);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            il0I01IoO0I il0i01ioo0i2 = new il0I01IoO0I();
/* 47 */            il0i01ioo0i2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(il0i01ioo0i2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(24);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             il0o1iIIol il0o1iiiol = (il0o1iIIol) ilIO00o1.I00000oOI(il0o1iIIol.class);
/* 9 */             if (il0o1iiiol != null) {
/* 11 */                return il0o1iiiol.zza();
                    }
...
/* 326 */                       if (obj instanceof il0iol1liio) {
/* 334 */                           I00000oOI(ilIO00o1, ((il0iol1liio) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            il0o1iIIol il0o1iiiol = (il0o1iIIol) ilIO00o1.I00000oOI(il0o1iIIol.class);
/* 13 */            if (il0o1iiiol == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = il0o1iiiol.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(il0o1iiiol.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(il0o1iiiol.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((il0o1iiiol.zza() << 3) | 5);
...
/* 15 */            il0o1iIIol il0o1iiiol = (il0o1iIIol) ilIO00o1.I00000oOI(il0o1iIIol.class);
/* 17 */            if (il0o1iiiol == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = il0o1iiiol.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(il0o1iiiol.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(il0o1iiiol.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((il0o1iiiol.zza() << 3) | 1);
...
/* 5 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(8);
