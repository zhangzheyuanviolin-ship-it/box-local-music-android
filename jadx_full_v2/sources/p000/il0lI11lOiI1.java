...
/* 4 */     public final class il0lI11lOiI1 implements OIOi0o {
                ...
                public OIOi0lOI I0000O;
                public OOiI1O I0000oI00;

                static {
/* 11 */            OlOO1i11110 olOO1i11110I00000oIO = IlIO00o1.I00000oIO("key");
/* 17 */            iiooo00 iiooo00Var = new iiooo00();
/* 21 */            iiooo00Var.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(iiooo00Var);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            iiooo00 iiooo00Var2 = new iiooo00();
/* 47 */            iiooo00Var2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(iiooo00Var2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 63 */            I000OOo1O = iIOo0oiIi1.I000O01llI0;
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             il0iOo0oII10 il0ioo0oii10 = (il0iOo0oII10) ilIO00o1.I00000oOI(il0iOo0oII10.class);
/* 9 */             if (il0ioo0oii10 != null) {
/* 11 */                return il0ioo0oii10.zza();
                    }
/* 18 */            iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 21 */            return 0;
                }

                public final OIOi0o I00000oIO(IlIO00o1 ilIO00o1, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
/* 1 */             if (obj != null) {
/* 7 */                 if (obj instanceof CharSequence) {
/* 9 */                     CharSequence charSequence = (CharSequence) obj;
/* 11 */                    if (!z || charSequence.length() != 0) {
/* 29 */                        I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 2);
...
/* 192 */                       I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 5);
...
/* 327 */                       if (obj instanceof il01ioolo) {
/* 335 */                           I00000oOI(ilIO00o1, ((il01ioolo) obj).zza(), true);
/* 338 */                           return this;
                                }
/* 341 */                       if (obj instanceof Enum) {
/* 349 */                           I00000oOI(ilIO00o1, ((Enum) obj).ordinal(), true);
/* 352 */                           return this;
                                }
/* 355 */                       I0000oI00(this.I0000O, ilIO00o1, obj, z);
/* 408 */                       return this;
                            }
/* 252 */                   byte[] bArr = (byte[]) obj;
/* 254 */                   if (!z || bArr.length != 0) {
/* 268 */                       I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 2);
...
/* 259 */           return this;
                ...
                public final void I00000oOI(IlIO00o1 ilIO00o1, int i, boolean z) throws IOException {
/* 1 */             if (z && i == 0) {
/* 31 */                return;
                    }
/* 11 */            il0iOo0oII10 il0ioo0oii10 = (il0iOo0oII10) ilIO00o1.I00000oOI(il0iOo0oII10.class);
/* 13 */            if (il0ioo0oii10 == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = il0ioo0oii10.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(il0ioo0oii10.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(il0ioo0oii10.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((il0ioo0oii10.zza() << 3) | 5);
...
/* 15 */            il0iOo0oII10 il0ioo0oii10 = (il0iOo0oII10) ilIO00o1.I00000oOI(il0iOo0oII10.class);
/* 17 */            if (il0ioo0oii10 == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = il0ioo0oii10.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(il0ioo0oii10.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(il0ioo0oii10.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((il0ioo0oii10.zza() << 3) | 1);
/* 68 */                this.I00000oIO.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putLong(j).array());
                    }
                }

                public final void I0000oI00(OIOi0lOI oIOi0lOI, IlIO00o1 ilIO00o1, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
/* 6 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(7);
/* 11 */            o0oIolOOo.I00iiI = 0L;
                    try {
/* 13 */                OutputStream outputStream = this.I00000oIO;
/* 15 */                this.I00000oIO = o0oIolOOo;
                        try {
/* 17 */                    oIOi0lOI.encode(obj, this);
/* 20 */                    this.I00000oIO = outputStream;
/* 22 */                    long j = o0oIolOOo.I00iiI;
/* 24 */                    o0oIolOOo.close();
/* 27 */                    if (z && j == 0) {
/* 33 */                        return;
                            }
/* 42 */                    I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 2);
/* 45 */                    I000II(j);
/* 48 */                    oIOi0lOI.encode(obj, this);
                        } catch (Throwable th) {
/* 55 */                    this.I00000oIO = outputStream;
/* 57 */                    throw th;
                        }
                    } catch (Throwable th2) {
                        try {
/* 58 */                    o0oIolOOo.close();
                            ...
                            try {
/* 77 */                        Throwable.class.getDeclaredMethod("addSuppressed", Throwable.class).invoke(th2, th3);
...
/* 6 */             I0000Il00O(ilIO00o1, j, true);
                ...
                @Override
/* 6 */         public final OIOi0o add(IlIO00o1 ilIO00o1, Object obj) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
