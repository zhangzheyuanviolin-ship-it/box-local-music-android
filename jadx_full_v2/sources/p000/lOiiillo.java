            ...
            public abstract class lOiiillo {
...
/* 1 */             lOiIl0iIi loiil0iii = null;
                    try {
/* 13 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(20));
                    } catch (Throwable unused) {
/* 16 */                unsafe = null;
                    }
/* 17 */            I00000oIO = unsafe;
/* 19 */            int i = l1IooI.I00000oIO;
...
/* 39 */            if (unsafe != null) {
/* 42 */                if (zI000l1) {
/* 46 */                    loiil0iii = new lOiIl0iIi(unsafe, c == true ? 1 : 0);
                        } else if (zI000l12) {
/* 54 */                    loiil0iii = new lOiIl0iIi(unsafe, i2);
                        }
                    }
/* 57 */            I0000Il00O = loiil0iii;
/* 75 */            if (loiil0iii == null) {
/* 77 */                z = false;
                    } else {
                        try {
/* 81 */                    Class<?> cls3 = loiil0iii.I00000oOI.getClass();
...
/* 127 */                   Logger.getLogger(lOiiillo.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 131 */           I0000O = z;
...
/* 245 */                   Logger.getLogger(lOiiillo.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 249 */           I0000oI00 = z2;
