...
/* 4 */     public final class l0i1lOIl implements OIOi0o {
...
/* 17 */            l0OI1ioioli l0oi1ioioli = new l0OI1ioioli();
/* 21 */            l0oi1ioioli.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(l0oi1ioioli);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            l0OI1ioioli l0oi1ioioli2 = new l0OI1ioioli();
/* 47 */            l0oi1ioioli2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(l0oi1ioioli2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(29);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             l0i0i0 l0i0i0Var = (l0i0i0) ilIO00o1.I00000oOI(l0i0i0.class);
/* 9 */             if (l0i0i0Var != null) {
/* 11 */                return l0i0i0Var.zza();
                    }
...
/* 326 */                       if (obj instanceof l0OliOOil0I) {
/* 334 */                           I00000oOI(ilIO00o1, ((l0OliOOil0I) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            l0i0i0 l0i0i0Var = (l0i0i0) ilIO00o1.I00000oOI(l0i0i0.class);
/* 13 */            if (l0i0i0Var == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = l0i0i0Var.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(l0i0i0Var.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(l0i0i0Var.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((l0i0i0Var.zza() << 3) | 5);
...
/* 15 */            l0i0i0 l0i0i0Var = (l0i0i0) ilIO00o1.I00000oOI(l0i0i0.class);
/* 17 */            if (l0i0i0Var == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = l0i0i0Var.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(l0i0i0Var.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(l0i0i0Var.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((l0i0i0Var.zza() << 3) | 1);
...
/* 5 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(11);
