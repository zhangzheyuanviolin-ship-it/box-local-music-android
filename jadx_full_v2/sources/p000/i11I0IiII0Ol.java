            ...
            public abstract class i11I0IiII0Ol implements Iterable, Serializable {
                public static final i111ol I00iiI = new i111ol(i11Oo1I1i.I00000oOI);
                public int I00iOIl;

                static {
/* 10 */            int i = i111I1I110lI.I00000oIO;
                }
...
/* 10 */            i111ol i111olVar = (i111ol) this;
/* 13 */            int i2 = iI0000oI00;
/* 14 */            for (int i3 = 0; i3 < iI0000oI00; i3++) {
/* 22 */                i2 = (i2 * 31) + i111olVar.I00iiO[i3];
                    }
/* 26 */            if (i2 == 0) {
/* 28 */                i2 = 1;
                    }
...
/* 4 */             IIO11lll1OOi iIO11lll1OOi = new IIO11lll1OOi(3);
...
/* 21 */            if (I0000oI00() <= 50) {
/* 23 */                strConcat = liOIo1o10lIo.I00000oIO(this);
                    } else {
/* 28 */                i111ol i111olVar2 = (i111ol) this;
/* 37 */                int iI0001Ioi1lo = I0001Ioi1lo(0, 47, i111olVar2.I0000oI00());
/* 41 */                if (iI0001Ioi1lo == 0) {
/* 43 */                    i111olVar = I00iiI;
                        } else {
/* 48 */                    byte[] bArr = i111olVar2.I00iiO;
/* 50 */                    i111lIOIi010 i111lioii010 = new i111lIOIi010(bArr);
/* 54 */                    I0001Ioi1lo(0, iI0001Ioi1lo, bArr.length);
/* 57 */                    i111lioii010.I00iio = iI0001Ioi1lo;
/* 59 */                    VarHandle.storeStoreFence();
/* 62 */                    i111olVar = i111lioii010;
                        }
/* 69 */                strConcat = liOIo1o10lIo.I00000oIO(i111olVar).concat("...");
                    }
