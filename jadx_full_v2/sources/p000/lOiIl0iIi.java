            ...
            public final class lOiIl0iIi extends Ooil0oIOI0l0 {
                public final int I0000Il00O;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public lOiIl0iIi(Unsafe unsafe, int i) {
/* 5 */             super(unsafe, 13);
/* 1 */             this.I0000Il00O = i;
                }
...
/* 12 */            return Float.intBitsToFloat(unsafe.getInt(obj, j));
                ...
                public final void I001iOo1i0O(Object obj, long j, boolean z) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 20 */                    if (!lOiiillo.I000II) {
/* 26 */                        lOiiillo.I0000O(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            } else {
/* 22 */                        lOiiillo.I0000Il00O(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            }
                        default:
/* 8 */                     if (!lOiiillo.I000II) {
/* 14 */                        lOiiillo.I0000O(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            } else {
/* 10 */                        lOiiillo.I0000Il00O(obj, j, z ? (byte) 1 : (byte) 0);
                                break;
                            }
                    }
                }
                ...
                public final void I001lIiIIo1O(Object obj, long j, byte b) {
                    switch (this.I0000Il00O) {
                        case 0:
/* 20 */                    if (!lOiiillo.I000II) {
/* 26 */                        lOiiillo.I0000O(obj, j, b);
                                break;
                            } else {
/* 22 */                        lOiiillo.I0000Il00O(obj, j, b);
                                break;
                            }
                        default:
/* 8 */                     if (!lOiiillo.I000II) {
/* 14 */                        lOiiillo.I0000O(obj, j, b);
                                break;
                            } else {
/* 10 */                        lOiiillo.I0000Il00O(obj, j, b);
                                break;
                            }
                    }
                }
...
/* 15 */            return lOiiillo.I000iOII(obj, j);
                }
            }
