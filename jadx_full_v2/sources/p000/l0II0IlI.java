            ...
            public abstract class l0II0IlI {
...
/* 1 */             l01oOIO l01ooio = null;
                    try {
/* 13 */                unsafe = (Unsafe) AccessController.doPrivileged(new OoiioO0o(18));
                    } catch (Throwable unused) {
/* 16 */                unsafe = null;
                    }
/* 17 */            I00000oIO = unsafe;
/* 19 */            int i = il0OiiIoo.I00000oIO;
...
/* 39 */            if (unsafe != null) {
/* 42 */                if (zI000l1) {
/* 46 */                    l01ooio = new l01oOIO(unsafe, c == true ? 1 : 0);
                        } else if (zI000l12) {
/* 54 */                    l01ooio = new l01oOIO(unsafe, i2);
                        }
                    }
/* 57 */            I0000Il00O = l01ooio;
/* 75 */            if (l01ooio == null) {
/* 77 */                z = false;
                    } else {
                        try {
/* 81 */                    Class<?> cls3 = l01ooio.I00000oOI.getClass();
...
/* 127 */                   Logger.getLogger(l0II0IlI.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
                        }
                    }
/* 131 */           I0000O = z;
...
/* 245 */                   Logger.getLogger(l0II0IlI.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th2.toString()));
                        }
                    }
/* 249 */           I0000oI00 = z2;
