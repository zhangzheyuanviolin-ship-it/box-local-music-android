...
/* 4 */     public final class ll0iI0i implements OIOi0o {
                ...
                public static final l0iO10io0IOO I000OOo1O;
...
/* 17 */            lioll0I0i1 lioll0i0i1 = new lioll0I0i1();
/* 21 */            lioll0i0i1.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(lioll0i0i1);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            lioll0I0i1 lioll0i0i12 = new lioll0I0i1();
/* 47 */            lioll0i0i12.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(lioll0i0i12);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 63 */            I000OOo1O = l0iO10io0IOO.I00000oOI;
                }

                public static int I0000oI00(IlIO00o1 ilIO00o1) {
/* 7 */             ll0I1l0 ll0i1l0 = (ll0I1l0) ilIO00o1.I00000oOI(ll0I1l0.class);
/* 9 */             if (ll0i1l0 != null) {
/* 11 */                return ll0i1l0.zza();
                    }
/* 18 */            iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 21 */            return 0;
                }

                public final void I00000oIO(IlIO00o1 ilIO00o1, Object obj, boolean z) throws IOException {
/* 1 */             if (obj == null) {
/* 258 */               return;
                    }
...
/* 27 */                I0001Ioi1lo((I0000oI00(ilIO00o1) << 3) | 2);
...
/* 267 */               I0001Ioi1lo((I0000oI00(ilIO00o1) << 3) | 2);
...
/* 294 */               I0000O(oIOi0lOI, ilIO00o1, obj, z);
/* 297 */               return;
                    }
...
/* 326 */           if (obj instanceof ll010iiiiiio) {
/* 334 */               I00000oOI(ilIO00o1, ((ll010iiiiiio) obj).zza(), true);
                    } else if (obj instanceof Enum) {
/* 348 */               I00000oOI(ilIO00o1, ((Enum) obj).ordinal(), true);
                    } else {
/* 354 */               I0000O(this.I0000O, ilIO00o1, obj, z);
                    }
                }
...
/* 11 */            ll0I1l0 ll0i1l0 = (ll0I1l0) ilIO00o1.I00000oOI(ll0I1l0.class);
/* 13 */            if (ll0i1l0 == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = ll0i1l0.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(ll0i1l0.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(ll0i1l0.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((ll0i1l0.zza() << 3) | 5);
...
/* 15 */            ll0I1l0 ll0i1l0 = (ll0I1l0) ilIO00o1.I00000oOI(ll0I1l0.class);
/* 17 */            if (ll0i1l0 == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = ll0i1l0.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(ll0i1l0.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(ll0i1l0.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((ll0i1l0.zza() << 3) | 1);
...
/* 5 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(15);
...
/* 41 */                    I0001Ioi1lo((I0000oI00(ilIO00o1) << 3) | 2);
/* 44 */                    I000II(j);
...
/* 6 */             I0000Il00O(ilIO00o1, j, true);
                ...
                @Override
/* 6 */         public final OIOi0o add(IlIO00o1 ilIO00o1, Object obj) throws IOException {
