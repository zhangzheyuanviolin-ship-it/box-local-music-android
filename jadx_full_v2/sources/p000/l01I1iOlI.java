...
/* 6 */     public class l01I1iOlI extends AbstractExecutorService implements AutoCloseable, ExecutorService {
                public final ExecutorService I00iOIl;

                public l01I1iOlI(ExecutorService executorService) {
...
/* 7 */             return new l0Il1lOIo(Executors.callable(runnable, obj));
                }
...
/* 12 */            return new l0Il1lOIo(callable);
                }
            }
