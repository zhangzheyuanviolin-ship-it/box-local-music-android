            ...
            public final class llIoiI extends llII0l1O1l1 {
                public Serializable I00iOIl;

                public static boolean I000OiO(llIoiI llioii) {
/* 1 */             Serializable serializable = llioii.I00iOIl;
...
/* 18 */                return new llooo1oooI((String) serializable);
                    }
...
/* 33 */            ll10OIO0I.I00000oOI(strI0001Ioi1lo);
...
/* 7 */             if (obj == null || llIoiI.class != obj.getClass()) {
/* 198 */               return false;
                    }
/* 19 */            llIoiI llioii = (llIoiI) obj;
/* 21 */            Serializable serializable2 = llioii.I00iOIl;
/* 27 */            if (I000OiO(this) && I000OiO(llioii)) {
                        return ((serializable instanceof BigInteger) || (serializable2 instanceof BigInteger)) ? I000OOo1O().equals(llioii.I000OOo1O()) : I0000oI00().longValue() == llioii.I0000oI00().longValue();
                    }
...
/* 89 */            if ((serializable instanceof BigDecimal) && (serializable2 instanceof BigDecimal)) {
                        return (serializable instanceof BigDecimal ? (BigDecimal) serializable : ll10OIO0I.I00000oIO(I0001Ioi1lo())).compareTo(serializable2 instanceof BigDecimal ? (BigDecimal) serializable2 : ll10OIO0I.I00000oIO(llioii.I0001Ioi1lo())) == 0;
                    }
/* 149 */           double dDoubleValue = serializable instanceof Number ? I0000oI00().doubleValue() : Double.parseDouble(I0001Ioi1lo());
/* 170 */           double dDoubleValue2 = serializable2 instanceof Number ? llioii.I0000oI00().doubleValue() : Double.parseDouble(llioii.I0001Ioi1lo());
