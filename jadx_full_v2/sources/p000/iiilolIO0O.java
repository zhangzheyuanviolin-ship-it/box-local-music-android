...
/* 4 */     public final class iiilolIO0O implements OIOi0o {
...
/* 17 */            iiOII1o1OiI iioii1o1oii = new iiOII1o1OiI();
/* 21 */            iioii1o1oii.I0000O = 1;
/* 23 */            VarHandle.storeStoreFence();
/* 26 */            olOO1i11110I00000oIO.I001i1lo1io(iioii1o1oii);
/* 33 */            I000II = olOO1i11110I00000oIO.I000O01llI0();
/* 37 */            OlOO1i11110 olOO1i11110I00000oIO2 = IlIO00o1.I00000oIO("value");
/* 43 */            iiOII1o1OiI iioii1o1oii2 = new iiOII1o1OiI();
/* 47 */            iioii1o1oii2.I0000O = 2;
/* 49 */            VarHandle.storeStoreFence();
/* 52 */            olOO1i11110I00000oIO2.I001i1lo1io(iioii1o1oii2);
/* 59 */            I000O01llI0 = olOO1i11110I00000oIO2.I000O01llI0();
/* 68 */            I000OOo1O = new iIOo0oiIi1(18);
                }

                public static int I0000O(IlIO00o1 ilIO00o1) {
/* 7 */             iiiOO0il iiioo0il = (iiiOO0il) ilIO00o1.I00000oOI(iiiOO0il.class);
/* 9 */             if (iiioo0il != null) {
/* 11 */                return iiioo0il.zza();
                    }
...
/* 326 */                       if (obj instanceof iiOooOii1) {
/* 334 */                           I00000oOI(ilIO00o1, ((iiOooOii1) obj).zza(), true);
/* 337 */                           return this;
                                }
...
/* 11 */            iiiOO0il iiioo0il = (iiiOO0il) ilIO00o1.I00000oOI(iiiOO0il.class);
/* 13 */            if (iiioo0il == null) {
/* 101 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 19 */            int iOrdinal = iiioo0il.zzb().ordinal();
/* 23 */            if (iOrdinal == 0) {
/* 92 */                I0001Ioi1lo(iiioo0il.zza() << 3);
/* 95 */                I0001Ioi1lo(i);
                    } else if (iOrdinal == 1) {
/* 74 */                I0001Ioi1lo(iiioo0il.zza() << 3);
/* 82 */                I0001Ioi1lo((i + i) ^ (i >> 31));
                    } else {
/* 29 */                if (iOrdinal != 2) {
/* 31 */                    return;
                        }
/* 40 */                I0001Ioi1lo((iiioo0il.zza() << 3) | 5);
...
/* 15 */            iiiOO0il iiioo0il = (iiiOO0il) ilIO00o1.I00000oOI(iiiOO0il.class);
/* 17 */            if (iiioo0il == null) {
/* 107 */               iilo0lOo110.I0000O("Field has no @Protobuf config");
/* 408 */               return;
                    }
/* 23 */            int iOrdinal = iiioo0il.zzb().ordinal();
/* 27 */            if (iOrdinal == 0) {
/* 98 */                I0001Ioi1lo(iiioo0il.zza() << 3);
/* 101 */               I000II(j);
                    } else if (iOrdinal == 1) {
/* 78 */                I0001Ioi1lo(iiioo0il.zza() << 3);
/* 88 */                I000II((j >> 63) ^ (j + j));
                    } else {
/* 33 */                if (iOrdinal != 2) {
/* 35 */                    return;
                        }
/* 43 */                I0001Ioi1lo((iiioo0il.zza() << 3) | 1);
...
/* 4 */             O0oIolOOo o0oIolOOo = new O0oIolOOo(3);
...
/* 39 */                    I0001Ioi1lo((I0000O(ilIO00o1) << 3) | 2);
/* 42 */                    I000II(j);
/* 45 */                    oIOi0lOI.encode(obj, this);
                        } catch (Throwable th) {
/* 52 */                    this.I00000oIO = outputStream;
/* 54 */                    throw th;
                        }
                    } catch (Throwable th2) {
                        try {
