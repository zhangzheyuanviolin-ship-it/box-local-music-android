...
/* 46 */    public final class TenVadModelConfig {
                ...
                public TenVadModelConfig(String str, float f, float f2, float f3, int i, float f4, int i2, DefaultConstructorMarker defaultConstructorMarker) {
/* 44 */            this((i2 & 1) != 0 ? "" : str, (i2 & 2) != 0 ? 0.5f : f, (i2 & 4) != 0 ? 0.25f : f2, (i2 & 8) != 0 ? 0.25f : f3, (i2 & 16) != 0 ? Barcode.FORMAT_QR_CODE : i, (i2 & 32) != 0 ? 5.0f : f4);
                }

                public static TenVadModelConfig copy$default(TenVadModelConfig tenVadModelConfig, String str, float f, float f2, float f3, int i, float f4, int i2, Object obj) {
/* 3 */             if ((i2 & 1) != 0) {
/* 5 */                 str = tenVadModelConfig.model;
                    }
/* 9 */             if ((i2 & 2) != 0) {
/* 11 */                f = tenVadModelConfig.threshold;
                    }
/* 15 */            if ((i2 & 4) != 0) {
/* 17 */                f2 = tenVadModelConfig.minSilenceDuration;
                    }
/* 21 */            if ((i2 & 8) != 0) {
/* 23 */                f3 = tenVadModelConfig.minSpeechDuration;
                    }
/* 27 */            if ((i2 & 16) != 0) {
/* 29 */                i = tenVadModelConfig.windowSize;
                    }
/* 33 */            if ((i2 & 32) != 0) {
/* 35 */                f4 = tenVadModelConfig.maxSpeechDuration;
                    }
/* 37 */            int i3 = i;
/* 38 */            float f5 = f4;
/* 44 */            return tenVadModelConfig.copy(str, f, f2, f3, i3, f5);
                }
...
/* 3 */             return new TenVadModelConfig(model, threshold, minSilenceDuration, minSpeechDuration, windowSize, maxSpeechDuration);
                }
...
/* 8 */             if (!(other instanceof TenVadModelConfig)) {
/* 7 */                 return false;
                    }
/* 11 */            TenVadModelConfig tenVadModelConfig = (TenVadModelConfig) other;
                    return O0000Ioio00.I0000O(this.model, tenVadModelConfig.model) && Float.compare(this.threshold, tenVadModelConfig.threshold) == 0 && Float.compare(this.minSilenceDuration, tenVadModelConfig.minSilenceDuration) == 0 && Float.compare(this.minSpeechDuration, tenVadModelConfig.minSpeechDuration) == 0 && this.windowSize == tenVadModelConfig.windowSize && Float.compare(this.maxSpeechDuration, tenVadModelConfig.maxSpeechDuration) == 0;
                }
...
/* 68 */            return "TenVadModelConfig(model=" + this.model + ", threshold=" + this.threshold + ", minSilenceDuration=" + this.minSilenceDuration + ", minSpeechDuration=" + this.minSpeechDuration + ", windowSize=" + this.windowSize + ", maxSpeechDuration=" + this.maxSpeechDuration + ')';
                }

/* 47 */        public TenVadModelConfig(String str, float f, float f2, float f3, int i, float f4) {
/* 49 */            this.model = str;
/* 50 */            this.threshold = f;
